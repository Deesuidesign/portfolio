...
const certifications = [
  {
    logo: "https://www.ci.oswego.or.us/sites/default/files/imageattachments/Linkedin-Learning-square.png",
  ...
  {
    logo: "https://vzy.s3.amazonaws.com/uploads/64b8dff72ddb8f8a1a8a70bd/9dbgp4v4_1689846383759.png",
    title: "Entry Level",
  ...
  {
    logo: "https://res.cloudinary.com/delbjwwfy/image/upload/v1726134993/Lynda_Logo_cvr9bt.png",
    title: "Lynda",
  ...
  {
    logo: "https://vzy.s3.amazonaws.com/uploads/64b8dff72ddb8f8a1a8a70bd/cd0qgvmh_1689845920268.png",
  ...
  {
    logo: "https://vzy.s3.amazonaws.com/uploads/64b8dff72ddb8f8a1a8a70bd/qhwdxh38_1689846008028.png",
    title: "Udemy",
        ...
        {certifications.map((cert, index) => (
          ...
          >
            <div className=" flex items-center justify-center rounded-full w-24 h-24">
              <Image className="rounded-2xl " width={100} height={100} src={cert.logo} alt={cert.title} />
            </div>
